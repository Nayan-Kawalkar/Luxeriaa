...
// A web budget for a car body is a few hundred thousand triangles, not a few
// million. Set per-car below; override for a one-off run with SIMPLIFY_RATIO.
const RATIO = Number(process.env.SIMPLIFY_RATIO ?? 0.25);

const TARGETS = [
  // Source GLBs live one level up, alongside the rest of the Tripo exports.
  // They arrive meshopt-compressed already; this pass is about the atlases and
  // the triangle count, not the container.
  {
    src: '../tripo_pbr_model_9fb05ff8-2034-466d-9fd4-9543226d51c0_meshopt.glb',
    out: 'aurum.glb',
    simplifyRatio: RATIO,
    // Tightly packed UV islands with specular streaks painted into the albedo:
    // at 2048 the mip chain smears island edges together and the bodywork reads
    // as crumpled foil. 4K is where it settles.
    textureLimits: { baseColorTexture: 4096 },
  },
  {
    src: '../tripo_pbr_model_49ea2fa0-45fd-45fb-ab26-b4f89fca2b9d_meshopt.glb',
    out: 'nocturne.glb',
    simplifyRatio: RATIO,
    textureLimits: { baseColorTexture: 4096 },
  },
  {
    src: '../tripo_pbr_model_5aff753b-d8df-463c-9923-c88d7449a12e_meshopt.glb',
    out: 'vermilion.glb',
    simplifyRatio: RATIO,
    textureLimits: { baseColorTexture: 4096 },
  },
  {
    src: '../tripo_pbr_model_21d13689-ef6c-46b8-aa8a-7167ff84ad2c_meshopt.glb',
    out: 'solaire.glb',
    simplifyRatio: RATIO,
    textureLimits: { baseColorTexture: 4096 },
  },
  {
    src: '../tripo_pbr_model_bf326105-c644-49be-872d-9bc7bedade9b_meshopt.glb',
    out: 'viridian.glb',
    simplifyRatio: RATIO,
    textureLimits: { baseColorTexture: 4096 },
  },
